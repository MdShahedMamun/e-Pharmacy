...
<html>
    ...
    <head>
        <title>Pain Killer | e-pharmacy </title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            ...
                            <%
                                ArrayList<Product> productList = (ArrayList<Product>) session.getAttribute("painkillerList");
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <!--CART-->
                                            <form action="PainkillerServlet" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userEmail") != null) {%>PainkillerServlet<%} else {%>loginSignup.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="PainkillerServlet" method="post">
