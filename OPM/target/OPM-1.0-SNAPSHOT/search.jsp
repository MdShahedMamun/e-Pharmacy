<%-- 
    Document   : search
    Created on : Mar 30, 2016, 10:49:01 PM
    Author     : shahed
--%>
...
<!--                                        <div class="product-overlay">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userEmail") != null) {%>SearchServlet<%} else {%>loginSignup.jsp<%}%>" method="post">
