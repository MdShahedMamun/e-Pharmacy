<%-- 
    Document   : index
    Created on : Mar 3, 2016, 10:39:34 PM
--%>
...
<html>
    ...
    <body> 
        ...
        <% if (session.getAttribute("firstServletCall") == null) { %>
        <jsp:include page="HomePageServlet" flush="true" />
        <%
                session.setAttribute("firstServletCall", "somthing");              // prothome servlet call hobe then nicher gulo execute hobe . er pore kono action ghotle then servlet call hobe
            } %>
                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="PainkillerServlet"><button type="button" style="margin-left:50px;" class="btn btn-default get">Get it now</button></a>
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="FeverServlet"><button type="button" style="margin-left:10px;" class="btn btn-default get">Get it now</button></a>

                                        <h2>20 Tk off </h2>
                                        <p>1 file Ace+ is at 80 taka</p>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="BloodPressureServlet"><button type="button" style="margin-left:20px;" class="btn btn-default get">Get it now</button></a>
...
<!--                                        <div class="product-overlay">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userEmail") != null) {%>HomePageServlet<%} else {%>loginSignup.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="HomePageServlet" method="post">
