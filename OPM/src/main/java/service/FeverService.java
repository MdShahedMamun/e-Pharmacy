...
public class FeverService {
        private static ArrayList<Product> feverList;
    ...
    public static ArrayList<Product> getFeverList() {
        try {
            feverList = new ArrayList<>();

            String query = "select*from product where subcategory_id=1";
            ...
            while (productResultSet.next()) {
                ...
                feverList.add(product);    // ei productList theke product for-each loop use kore extract kora
