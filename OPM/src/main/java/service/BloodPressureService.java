...
public class BloodPressureService {
    ...
    private static ArrayList<Product> bloodPressureList;
    ...
    public static ArrayList<Product> getbloodPressureList() {
        try {
            bloodPressureList = new ArrayList<>();

            String query = "select*from product where subcategory_id=5 or subcategory_id=6 or subcategory_id=7";
            ...
            while (productResultSet.next()) {
                ...
                bloodPressureList.add(product);    // ei productList theke product for-each loop use kore extract kora
