...
public class SearchService {
    ...
    private static ArrayList<Product> searchList;
    ...
    public static ArrayList<Product> getSearchList(String searchString) {
        try {
            searchList = new ArrayList<>();

            String query = "select subcategory_id from product where lower(product_description) like  '%" + searchString + "%'";
            ResultSet rs = getProductData(query);
            rs.next();
            ...
            while (productResultSet.next()) {
                ...
                searchList.add(product);    // ei productList theke product for-each loop use kore extract kora
