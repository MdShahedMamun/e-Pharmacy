...
<html lang="en">
    ...
    <%
        ...
        if (flag == 1) {
    %>
    <div style="margin-left: 500px"><br><br><br><br><br>Success! Have a nice exploring :)
        <form action="index.jsp" method="get">
            <button style="float: up; margin-left: 120px"class="btn btn-default check_out" type="submit">Start Buying :)</button>
        </form>
        <br><br><br><br>
    </div>
    <%} else if (flag == 2) {%>    <div style="margin-left: 500px"><br><br><br><br><br>Error in email or password. Try again</div>
        <% } else if (flag == 3) {%>
    <div style="margin-left: 500px"><br><br><br><br><br>This email already registered. Try another one</div>
        <%}
            session.setAttribute("flagEmail", flag); // logout korle session.setAttribut("flagEmail" 0 korte hobe r session invalidate korte hobe. 
        %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-sm-offset-1">
                    ...
                    <br>
                    <div class="login-form"><!--login form for Supplier-->
                        <h2>Login to supplier account</h2>
                        <form action="LoginServlet" method="POST">
                            <input type="email" name="email" placeholder="e-mail"/>
                            <input type="hidden" name="fromlog" value="yeslog">
                    ...
                    </div><!--/login form for supplier-->
                    <br>
                    <div class="login-form"><!--login as admin-->
