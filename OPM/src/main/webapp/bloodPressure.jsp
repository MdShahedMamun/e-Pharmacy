<%-- 
    ...
    Created on : Mar 26, 2016, 12:11:22 AM
...
<html>
    ...
    <head>
        <title>Blood Pressure | e-pharmacy </title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            ...
                            <%
                                ArrayList<Product> productList = (ArrayList<Product>) session.getAttribute("bloodPressureList");
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <!--CART-->
                                            <form action="BloodPressureServlet" method="post">
...
<!--                                        <div class="product-overlay">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userEmail") != null) {%>BloodPressureServlet<%} else {%>loginSignup.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="BloodPressureServlet" method="post">
