                    ...
                    <div class="col-sm-4">
                        <div class="signup-form"><!--sign up form-->
                            ...
                            <form action="InsertServlet" method="POST">
                                ...
                                <input type="text" name="product_sell_price" placeholder="Sell Price"/>
                                <input type="text" name="product_purchase_price" placeholder="Purchase Price"/>
                                <input type="text" name="product_exp_date" placeholder="Expire Date"/>
                                <input type="text" name="product_offer" placeholder="Offer"/>
                                <input type="text" name="stock" placeholder="Initial Stock"/>
